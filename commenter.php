<?php
    ...
    $commentData = $conn->real_escape_string($_POST["comment"]);
    $bookData = $_SESSION['currentBook'];

    $insertsql = "INSERT INTO ET_Comments (Comment_ID, Comment, Assoc_Book, Poster) VALUES (NULL, '$commentData', '$bookData', '$userId')";
 ...
 if(!$result){
   ...
   echo "<div id='index-banner' class='container'>
     <div class='section no-pad-bot'>
       <div class='container'>
         <h1 class='header center green-text text-lighten-2'>Comment successfully posted!</h1>
