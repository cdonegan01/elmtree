<?php
  ...
  $read = "SELECT * FROM ET_Books WHERE Buyer = '$userId' ORDER BY Date_Posted DESC";
...
<div id="itemList" class="container">
  ...
  <div class="row">
    <h1 class="header center green-text text-lighten-2">Your Purchased Books</h1>
  </div>
 	<?php
    if($num2 < 1 ) {
      echo "<h5 class='header col s12 center light'>You haven't bought any textbooks yet!</h5>";
    }else{
