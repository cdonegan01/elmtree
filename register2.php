<?php
    ...
    $insertsql = "UPDATE ET_Users SET Email = '$emaildata', Phone_Number = '$numberData', Profile_Picture = '$filename', User_Type = '2' WHERE Username = '$currentUser'";
  ...
  if(!$result){
    ...
    echo "<div id='index-banner' class='container'>
      <div class='section no-pad-bot'>
        <div class='container'>
          <h1 class='header center green-text text-lighten-2'>Congratulations! You are now a full member of ElmTree!</h1>
          <div class='row center'>
            <h5 class='header col s12 light'>You can now buy and sell to your heart's content!</h5>
            <div class='row center'>
              <a href='user.php' class='btn-large waves-effect waves-light green lighten-1'>Go to My Profile</a>
            </div>
          </div>
        </div>
      </div>
