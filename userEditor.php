<?php
    ...
    if($userTyp == 1) {
      $newUserType = 2;
      $insertsql = "UPDATE ET_Users SET Email = '$emaildata', Phone_Number = '$numberData', Profile_Picture = '$filename', User_Type = 2 WHERE User_ID = '$userId'";
      $_SESSION['myType'] = $newUserType;
  ...
  if(!$result){
    ...
    echo "<div id='index-banner' class='container'>
      <div class='section no-pad-bot'>
        <div class='container'>
          <h1 class='header center green-text text-lighten-2'>Your details have been edited successfully!</h1>
