...
$checkId = "SELECT * FROM ET_Users WHERE User_ID = '$getid'";
...
while($row = $result1->fetch_assoc()){
  ...
  $insertsql = "UPDATE ET_Users SET User_Rating = '$getNo' WHERE User_ID = '$getid'";

  $result = $conn->query($insertsql);

  $_SESSION['likedUser'] = $getid;
   ...
   if(!$result){
     ...
     echo "<div id='index-banner' class='container'>
       <div class='section no-pad-bot'>
         <div class='container'>
           <h1 class='header center green-text text-lighten-2'>The Seller has received your Like!</h1>
           <div class='row center'>
             <a href='otherUser.php?otherUserID=$getid' class='btn-large waves-effect waves-light green lighten-1'>Return</a>
           </div>
         </div>
       </div>
     </div>";
